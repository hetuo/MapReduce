 ...
 */
public class GreenJob {
    public static void main(String[] args) {
        try {
            Configuration conf = new Configuration();
            Job job1 = Job.getInstance(conf, "travel job1");
            job1.setJarByClass(GreenJob.class);
            job1.setMapperClass(GreenMapper1.class);
            //job1.setCombinerClass(TravelReducer1.class);
            job1.setReducerClass(GreenReducer1.class);
            ...
            job2.setJarByClass(GreenJob.class);
            job2.setMapperClass(GreenMapper2.class);
            //job2.setCombinerClass(TravelReducer2.class);
            job2.setReducerClass(GreenReducer2.class);
